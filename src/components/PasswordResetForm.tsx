			...
			<div class="flex w-full max-w-sm flex-col space-y-2">
				<Show when={!getEmailSent()}>
					...
					<div class="flex w-full justify-center">
						<span class="">
							...
							<a href="/auth/login" class="text-blue-500 underline hover:text-blue-600">
								Login
							</a>
						</span>
					</div>
				...
				<Show when={getEmailSent()}>
					<div class="flex w-full max-w-sm flex-col space-y-2 text-neutral-900 dark:text-neutral-50">
						<div class="text-center text-2xl font-bold">
							<span class="py-2">Check your email to finish resetting your password</span>
						</div>
						<div class="text-center">Your password reset link will expire in 5 minutes</div>
					</div>
				</Show>
			</div>
		</>
