                ...
                <tbody class="divide-y divide-gray-800">
                  <For each={collections()}>
                    {(collection) => (
                      <tr>
                        <td
                          class="cursor-pointer whitespace-nowrap py-4 pl-4 pr-3 text-sm font-semibold text-white"
                          onClick={(e) => {
                            e.preventDefault();
                        ...
                        <td class="whitespace-nowrap px-3 py-4 text-left text-sm text-gray-300">
                          {new Date(
